...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header" data-original-title>
            <h2><i class="halflings-icon edit"></i><span class="break"></span>Meeting Form</h2>
            <div class="box-icon">
            ...
            <form class="form-horizontal" action="" method="post">
                <fieldset>
                    <div class="control-group">
                        <label class="control-label" for="typeahead">Meeting Agenda </label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="typeahead">Meeting Date</label>
                        <div class="controls">
                    ...
                    <div class="control-group hidden-phone">
                        <label class="control-label" for="textarea2"> Meeting Details</label>
                        <div class="controls">
                   ...
                   <label for="designation" class="control-label">Designation</label>&nbsp &nbsp &nbsp
                    ...
                    <div class="form-actions">
                        <button type="submit" name="btn" class="btn btn-primary">Create Meeting</button>
