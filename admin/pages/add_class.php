...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header" data-original-title>
            <h2><i class="halflings-icon edit"></i><span class="break"></span>Make-Up Class Form</h2>
            <div class="box-icon">
        ...
        <div class="box-content">
            ...
            <form class="form-horizontal" action="" method="post">
                <fieldset>
                    ...
                    <div class="control-group">
                        <label class="control-label" for="typeahead">Class Date</label>
                        <div class="controls">
                    ...
                    <div class="control-group hidden-phone">
                        <label class="control-label" for="textarea2"> Make-Up class Details</label>
                        <div class="controls">
                    ...
                    <div class="form-actions">
                        <button type="submit" name="btn" class="btn btn-primary">Create A Make-Up Class</button>
